...
static void mavlink_test_hydrogen(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_HYDROGEN >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_hydrogen_t packet_in = {
        17.0,45.0,73.0,101.0,129.0,157.0
    };
    mavlink_hydrogen_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.stack_temp = packet_in.stack_temp;
        packet1.battery_voltage = packet_in.battery_voltage;
        packet1.stack_current = packet_in.stack_current;
        packet1.tank_pressure = packet_in.tank_pressure;
        packet1.stack_voltage = packet_in.stack_voltage;
        packet1.uav_mass = packet_in.uav_mass;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_HYDROGEN_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_HYDROGEN_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_hydrogen_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_hydrogen_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_hydrogen_pack(system_id, component_id, &msg , packet1.stack_temp , packet1.battery_voltage , packet1.stack_current , packet1.tank_pressure , packet1.stack_voltage , packet1.uav_mass );
    mavlink_msg_hydrogen_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_hydrogen_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.stack_temp , packet1.battery_voltage , packet1.stack_current , packet1.tank_pressure , packet1.stack_voltage , packet1.uav_mass );
    mavlink_msg_hydrogen_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_hydrogen_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_hydrogen_send(MAVLINK_COMM_1 , packet1.stack_temp , packet1.battery_voltage , packet1.stack_current , packet1.tank_pressure , packet1.stack_voltage , packet1.uav_mass );
    mavlink_msg_hydrogen_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_hydrogen_control(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_HYDROGEN_CONTROL >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_hydrogen_control_t packet_in = {
        5,72
    };
    mavlink_hydrogen_control_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.system_crash = packet_in.system_crash;
        packet1.start_hydro = packet_in.start_hydro;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_HYDROGEN_CONTROL_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_HYDROGEN_CONTROL_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_hydrogen_control_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_hydrogen_control_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_hydrogen_control_pack(system_id, component_id, &msg , packet1.system_crash , packet1.start_hydro );
    mavlink_msg_hydrogen_control_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_hydrogen_control_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.system_crash , packet1.start_hydro );
    mavlink_msg_hydrogen_control_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_hydrogen_control_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_hydrogen_control_send(MAVLINK_COMM_1 , packet1.system_crash , packet1.start_hydro );
    mavlink_msg_hydrogen_control_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_ardupilotmega(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_hydrogen(system_id, component_id, last_msg);
    mavlink_test_hydrogen_control(system_id, component_id, last_msg);
